...
# "2019-12-03 00:00:00"以前
ret_before = get_mecabed_strings(to_date_str="2018-12-01 00:00:00") #日付を変更
tw_list_before = ret_before['tweet_list']

# "2019-13-03 00:00:00"以降
ret_after = get_mecabed_strings(from_date_str="2019-11-30 00:00:00")#日付を変更
...
c_vec = CountVectorizer(stop_words=["CCレモン"])  # 「スタバ」は全Tweetに含まれるので除外
...
# トップ50がどの位置にあるかを取り出す
arg_ind = np.argsort(sub.toarray())[0][:-300:-1]
